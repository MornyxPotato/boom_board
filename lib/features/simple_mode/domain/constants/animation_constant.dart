const Duration laserBeam = Duration(milliseconds: 1000); // laser beam duration
const Duration destroyedTileDelay = Duration(
  milliseconds: 300,
); // How long after laser beam animation start playing until destroyed tile update
